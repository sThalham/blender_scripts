...
sample_dir = '/home/sthalham/data/renderings/linemod_test' #directory for temporary files (cam_L, cam_R, masks..~)
target_dir = '/home/sthalham/data/renderings/linemod_test/patches'
index=0
isfile=True
while isfile:
