...
base_dir = "/home/sthalham/data/t-less_v2/t-less_scaled(ST)"
back_dir = "/home/sthalham/data/CAD_stl/tless"
...
sample_dir = '/home/sthalham/data/renderings/tless_BG' #directory for temporary files (cam_L, cam_R, masks..~)
target_dir = '/home/sthalham/data/renderings/tless_BG/patches'
index=0
isfile=True
while isfile:
...
for num_set in np.arange(total_set):
    ...
    for i in np.arange(num_object):
        ...
        anchor_pose[i,2] = 0.7 + random()*0.3
    ...
    for i in np.arange(Back_object):
        ...
        anchor_pose[i+num_object-1,0] = random()*0.5-0.25
        anchor_pose[i+num_object-1,1] = random()*0.5-0.25
        #anchor_pose[i,2] = 0.4 + 0.2*float(i)
        anchor_pose[i+num_object-1,2] = 0.3 + random()*0.3
