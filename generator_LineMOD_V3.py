...
sample_dir = '/home/stefan/data/rendered_data/linemod_rgbd_V3' #directory for temporary files (cam_L, cam_R, masks..~)
target_dir = '/home/stefan/data/rendered_data/linemod_rgbd_V3/patches'
index=0
isfile=True
while isfile:
...
for num_set in np.arange(total_set):
    ...
    posesSam = [[0.3, 0.3], [0.3, 0.15], [0.3, 0.0], [0.3, -0.15], [0.3, -0.3],
              ...
              [-0.15, -0.3], [0.0, -0.3], [0.15, -0.3],
              [-0.3, 0.3], [-0.3, 0.3], [-0.3, 0.0], [-0.3, -0.15], [-0.3, -0.3]]
    ...
    for iii in np.arange(pair_set):
        ...
        for obj in scene.objects:
            ...
            if obj.type == 'CAMERA' and  obj.name=='cam_L':
                ...
                obj_object.location.z = random()*0.25+0.87
